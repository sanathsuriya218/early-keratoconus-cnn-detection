# 👁️ Keratoconus Eye Disease Detection Using CNN
...
[![Jupyter](https://img.shields.io/badge/Jupyter-Notebook-yellow?style=flat-square&logo=jupyter)](https://jupyter.org/)
...
- ⚖️ **Class imbalance handling** using oversampling to improve minority-class recall
...
| Matplotlib / Seaborn | Data visualization & result plots |
...
3. CNN architecture — multiple Conv2D → MaxPooling → Dropout → Dense layers
...
- End-to-end deep learning workflow: data → model → evaluation → interpretation
